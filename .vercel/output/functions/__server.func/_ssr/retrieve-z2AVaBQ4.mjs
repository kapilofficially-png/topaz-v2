//#region node_modules/.nitro/vite/services/ssr/assets/retrieve-z2AVaBQ4.js
...
function tokenize(input) {
	return input.toLowerCase().replace(/[–—]/g, " ").split(/[^a-z0-9\p{Script=Devanagari}]+/u).filter((t) => t.length > 1);
}
