//#region node_modules/.nitro/vite/services/ssr/assets/templates-zz7-2I6c.js
var PRACTICE_AREAS = [
	{
		id: "all",
		label: "All matters"
...
var TEMPLATES = [
	...
	},
	{
		...
		area: "ecommerce",
		forum: "Store policy",
		ragQuery: "e-commerce rules 2020 grievance officer consumer protection contact imprint IT Rules 2021 DPDP consent refund shipping terms India",
		instructions: "Draft a customer-facing Indian legal page that matches the SUBJECT of the live URL you are given. Keep it one document: if the live page is Contact/grievance, write legal name, registered office, emails, phones, hours, and a named grievance officer with acknowledgement and disposal timelines. If it is an FAQ legal page, keep Q&A form but make the answers CPA/DPDP-safe. Numbered clauses or short headed sections. Do not invent GSTIN, CIN or officer names. Not a pleading.",
		fields: [
			{
				key: "legalName",
				label: "Legal name",
			...
			},
			{
				...
				type: "text",
				required: true,
				placeholder: "Contact / grievance officer"
			},
			{
				key: "registeredOffice",
				label: "Registered office",
			...
			{
				key: "extras",
				label: "What the live page already says that must survive",
				type: "textarea"
			}
		],
		sample: {
		...
		fields: [
			{
				...
				type: "text",
				required: true,
				placeholder: "Kapil Rana"
			},
			{
				key: "drafterCity",
				label: "Drafter city / courts",
				type: "text",
				required: true,
				placeholder: "Hisar"
			},
			...
			{
				key: "pagesInScope",
				label: "Pages in scope (title + URL)",
				type: "textarea",
				required: true
			},
			{
				key: "fee",
				label: "Fixed fee (INR, excl. GST)",
				type: "text",
				required: true,
				placeholder: "25000"
			},
			...
			{
				key: "draftDays",
				label: "Draft working days after questionnaire",
				type: "text",
				placeholder: "7"
			},
			{
